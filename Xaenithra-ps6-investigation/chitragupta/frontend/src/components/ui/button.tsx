  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-display tracking-wide",
  {
    variants: {
      variant: {
        ...
        divine: "bg-gradient-to-r from-primary via-accent to-primary text-primary-foreground shadow-lg hover:shadow-[0_0_30px_hsl(43_80%_55%_/_0.5)] transition-all duration-300 border border-primary/30",
        sacred: "bg-secondary text-foreground border-2 border-primary/30 hover:border-primary hover:bg-secondary/80 shadow-md",
        seal: "bg-seal-red text-foreground rounded-full aspect-square p-0 shadow-lg hover:shadow-[0_0_20px_hsl(0_60%_35%_/_0.5)] border-2 border-seal-gold/50",
      },
      size: {
